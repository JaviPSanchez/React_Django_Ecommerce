...
const Shop = ({ get_categories, categories }) => {
  ...
  // Siempre que se llame a la pagina, se cargará get_categories()
  useEffect(() => {
    get_categories();
    window.scrollTo(0, 0);
  }, []);
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    <ul className="font-medium text-gray-900 px-2 py-3">
                      {categories &&
                        ...
                        categories.map((item) => {
                          // Trabajamos el object singular, sin subcategorias:
...
//Cargamos las variables que vienen de redux
